...
// File.
template <typename T>
struct MetaTypeOf<T, std::enable_if_t<internal::IsOpenSupported<T>{}>>
    : MetaTypeContant<MetaTypes::kFile> {};

// List.
template <typename T>
struct MetaTypeOf<T, std::enable_if_t<internal::IsAppendSupported<T>{}>>
    : MetaTypeContant<MetaTypes::kList> {};

// Number.
template <typename T>
struct MetaTypeOf<T, std::enable_if_t<internal::IsNumericType<T>{}>>
